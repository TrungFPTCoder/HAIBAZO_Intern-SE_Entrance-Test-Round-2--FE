...
import { Book, Users, MessageSquare, BookOpen } from "lucide-react";
...
export default function Sidebar({ onClose }) {
          ...
          <Link
            ...
            className={`text-sm! block! py-2! transition-all! ${
              location.pathname === "/books"
                ? "bg-violet-500/10! text-violet-400! font-semibold! border-l-2! border-violet-500! pl-3! rounded-r-xl! rounded-l-none!"
  ...
  return (
    <div className="flex flex-col h-full bg-[#280a28] p-4 text-white">
      {/* Brand Header */}
      <div className="flex items-center gap-3 px-3 py-4 mb-6 border-b border-[#1f2438]">
        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-linear-to-br from-violet-600 to-indigo-650 text-white shadow-md shadow-violet-500/20">
